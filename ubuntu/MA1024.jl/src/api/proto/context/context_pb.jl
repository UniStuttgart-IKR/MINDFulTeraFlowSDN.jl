# Autogenerated using ProtoBuf.jl v1.1.1 on 2025-06-04T15:45:30.050
...
@enumx LinkTypeEnum LINKTYPE_UNKNOWN=0 LINKTYPE_COPPER=1 LINKTYPE_FIBER=2 LINKTYPE_RADIO=3 LINKTYPE_VIRTUAL=4 LINKTYPE_MANAGEMENT=5
...
@enumx ServiceTypeEnum SERVICETYPE_UNKNOWN=0 SERVICETYPE_L3NM=1 SERVICETYPE_L2NM=2 SERVICETYPE_TAPI_CONNECTIVITY_SERVICE=3 SERVICETYPE_TE=4 SERVICETYPE_E2E=5 SERVICETYPE_OPTICAL_CONNECTIVITY=6 SERVICETYPE_QKD=7 SERVICETYPE_L1NM=8 SERVICETYPE_INT=9 SERVICETYPE_ACL=10
...
PB.default_values(::Type{Link}) = (;link_id = nothing, name = "", link_type = LinkTypeEnum.LINKTYPE_UNKNOWN, link_endpoint_ids = Vector{EndPointId}(), attributes = nothing)
PB.field_numbers(::Type{Link}) = (;link_id = 1, name = 2, link_type = 3, link_endpoint_ids = 4, attributes = 5)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Link})
    ...
    return Link(link_id[], name, link_type, link_endpoint_ids[], attributes[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::Link)
    ...
    !isempty(x.name) && PB.encode(e, 2, x.name)
    x.link_type != LinkTypeEnum.LINKTYPE_UNKNOWN && PB.encode(e, 3, x.link_type)
    !isempty(x.link_endpoint_ids) && PB.encode(e, 4, x.link_endpoint_ids)
    !isnothing(x.attributes) && PB.encode(e, 5, x.attributes)
    return position(e.io) - initpos
end
function PB._encoded_size(x::Link)
    ...
    !isempty(x.name) && (encoded_size += PB._encoded_size(x.name, 2))
    x.link_type != LinkTypeEnum.LINKTYPE_UNKNOWN && (encoded_size += PB._encoded_size(x.link_type, 3))
    !isempty(x.link_endpoint_ids) && (encoded_size += PB._encoded_size(x.link_endpoint_ids, 4))
    !isnothing(x.attributes) && (encoded_size += PB._encoded_size(x.attributes, 5))
    return encoded_size
end
...
struct EndPoint
    ...
    capabilities::Dict{String,google.protobuf.var"#Any"}
end
PB.default_values(::Type{EndPoint}) = (;endpoint_id = nothing, name = "", endpoint_type = "", kpi_sample_types = Vector{kpi_sample_types.KpiSampleType.T}(), endpoint_location = nothing, capabilities = Dict{String,google.protobuf.var"#Any"}())
PB.field_numbers(::Type{EndPoint}) = (;endpoint_id = 1, name = 2, endpoint_type = 3, kpi_sample_types = 4, endpoint_location = 5, capabilities = 6)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:EndPoint})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 6
            PB.decode!(d, capabilities)
        else
            PB.skip(d, wire_type)
        end
    end
    return EndPoint(endpoint_id[], name, endpoint_type, kpi_sample_types[], endpoint_location[], capabilities)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::EndPoint)
    ...
    !isempty(x.capabilities) && PB.encode(e, 6, x.capabilities)
    return position(e.io) - initpos
end
function PB._encoded_size(x::EndPoint)
    ...
    !isempty(x.capabilities) && (encoded_size += PB._encoded_size(x.capabilities, 6))
    return encoded_size
end
